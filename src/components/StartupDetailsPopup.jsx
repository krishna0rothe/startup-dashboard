...
export default function StartupDetailsPopup({
  startup,
  open,
  onClose,
  onStatusUpdate,
  ...
  return (
    <Dialog
      open={open}
      onClose={onClose}
      aria-labelledby="startup-details-dialog-title"
      maxWidth="md"
      fullWidth
    >
      ...
      <DialogContent dividers>
        <Grid container spacing={3}>
          <Grid item xs={12}>
            ...
            <Typography>
              <strong>Brief:</strong> {startup.brief}
            </Typography>
            <Typography>
              <strong>Stage:</strong> {startup.stage}
            </Typography>
            <Typography>
              <strong>Funded:</strong> {startup.funded}
            </Typography>
            <Typography>
